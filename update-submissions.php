<?php
/**
 * Directly update the submissions page template
 * Upload to public_html/ and visit once
 */

$file_path = __DIR__ . '/wp-content/themes/vpr-theme/page-journal-submissions.php';
...
echo "<h1>Updating Submissions Page</h1>";
...
echo "<p>✓ Backed up old file to: " . basename($backup_path) . "</p>";
