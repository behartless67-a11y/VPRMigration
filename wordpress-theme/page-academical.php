    ...
    <section style="padding: var(--spacing-lg) 0; background: var(--white);">
        <div class="container">
            <div class="text-center">
                <h1 style="font-size: 2.5rem; margin-bottom: var(--spacing-sm); font-family: var(--font-secondary);">Academical Podcast</h1>
                <p style="font-size: 1.1rem; color: var(--text-secondary); margin: 0;">The Official Podcast of the Virginia Policy Review</p>
            </div>
        </div>
    </section>
